...
public class UrgentCall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asliborneo.route.Utils.GifImageView gifImageView = (asliborneo.route.Utils.GifImageView) findViewById(R.id.GifImageView);
        gifImageView.setGifImageResource(R.drawable.urgent);
        ...
        accept_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UrgentCall.this, DriverTracking.class);
                ...
                enqueue(new Callback<FCMResponse>() {
                    ...
                    public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                        if (response.body().success == 1) {
                            Toast.makeText(UrgentCall.this, "Cancelled", Toast.LENGTH_LONG).show();


                        }
                        Intent intent = new Intent(UrgentCall.this, Driver_Home.class);
                        startActivity(intent);
                        finish();
                    }
        ...
        try {
            ...
            mService.getPath(requestApi).enqueue(new Callback<String>() {
                ...
                public void onFailure(Call<String> call, Throwable t) {
                    Toast.makeText(UrgentCall.this, "" + t.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
